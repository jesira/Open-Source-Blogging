...
<!--        <div><button type="submit" class="btn btn-primary" value="Most_Liked" formaction="mostLiked.php">Most Liked</button></div>-->
<!--        <div><button type="submit" class="btn btn-warning" value="Most_Recent" formaction="index.php">Most Recent</button></div>-->
        <h1>MyPosts</h1>
