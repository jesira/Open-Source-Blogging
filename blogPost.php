...
if (!(isset($_SESSION['user_id']))) {
    ...
    $category = dataFilter($_POST["sel1"]);
    var_dump($category);
    ...
    $sql = "INSERT INTO `user_blog` (`user_id`, `user_name`, `post_id`, `title`, `post`,`likes_count`, `report_count`,   `report_comment`, `time_date`,`blog_deleted`,`category`)
VALUES ('" . $_SESSION["user_id"] . "', '" . $_SESSION["user_name"] . "', NULL , '" . $title . "', '" . $blog . "', '" . $likes_count . "', '" . $report_count . "', NULL , '" . date("Y-m-d H:i:s") . "', NULL,'".$category."')";
